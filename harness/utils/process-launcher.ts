 ...
 * The initial set of modifications are copyright (c) Microsoft Corporation,
 * though we also made some minor modifications.
 *
...
function sigintHandler() {
  const exitWithCode130 = () => {
    // TODO: This was the original's justification for this; not sure it applies in our case:
